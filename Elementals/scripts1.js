...
function player1turn() {
    ...
    switch (p1choice) {
        ...
        case "wind":
            ...
            document.getElementById('windmoves1').style.display = "block";
                passive1.innerHTML = "Lifesteal 40%";
                    if (life1 > lifewind){
                        life1 = lifewind;
                    }
            break;
    ...
    switch (p2choice) {
        ...
        case "wind":
            ...
            passive2.innerHTML = "Lifesteal 40%";
                    if (life2 > lifewind){
                        life2 = lifewind;
                    }
            break;
...
let earthanimation1 = ["pics/animations/earthR1.png", "pics/animations/earthR2.png"],
...
let earthanimation2 = ["pics/animations/earthL1.png", "pics/animations/earthL2.png"],
